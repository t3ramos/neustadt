...
export interface GameEvent { id:number; month:number; title:string; message:string; type:'info'|'good'|'warning'; }
...
export interface PreviewInfo extends BuildPreview { screenX:number;screenY:number; tool:Tool; footprint?:[number,number]; elevation?:number; }
